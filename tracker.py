...
from pytracking.evaluation.dimp_tracker import Tracker
...
optional_box = [360, 325, 25, 111]
test_tracker.run_video_no_display(detector, reid_predictor, "/home/votlt/sequences/ballet/color", "./bike1", optional_box)

...
def run_video(tracker_name, tracker_param, videofile, optional_box=None, debug=None, save_results=False):
    ...
    args:
        ...
        debug: Debug level.
    """
    print(tracker_name, tracker_param)
    tracker = Tracker(tracker_name, tracker_param)
    tracker.run_video_no_display(videofilepath=videofile, output_dir="result.avi", optional_box=optional_box, debug=debug, save_results=save_results)

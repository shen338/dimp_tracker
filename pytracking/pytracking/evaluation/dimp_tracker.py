...
class Tracker:
    ...
    def run_video_no_display(self, detector, reid_predictor, videofilepath, output_dir, optional_box=None, debug=None, visdom_info=None, save_results=False):
...
#               'flag': flag}
                ...
                # if True:
                    ...
                    if len(detector_result.get_field("scores")) > 0:
                        ...
                        if max_detection_score > max_score: 
                            ...
                            final_result = best_detection_bbox
            ...
            if self.frames_since_lost > params.max_lost_frames_redetection:
                ...
                if len(detector_result.get_field("scores")) > 0:
                    ...
                    simlarity_score = np.dot(embeddings, np.array(target_reid_feature).T).mean(axis=1)

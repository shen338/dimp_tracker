...
def parameters():
    ...
    # Tracker, detector, reid integration parameters
    params.max_lost_frames_redetection = 10
    params.detector_freq = 5  # detector kicks in every N frame
    params.reid_input_size = 64
    params.reid_feature_budget = 20
    params.redetection_accept_threshold = 0.4
    # params.search_

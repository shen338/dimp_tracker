...
class DiMP(BaseTracker):
    ...
    def track(self, image, info: dict = None) -> dict:
        ...
        # print(sample_coords)
        out = {'target_bbox': output_state, "im_patches":im_patches, "sample_coords": sample_coords, "flag": flag, "max_score": max_score}
    ...
    def localize_target(self, scores, sample_pos, sample_scales):
        ...
        # print("score_sz: ", score_sz)
        score_center = (score_sz - 1)/2
        max_score, max_disp = dcf.max2d(scores)
        # print("max_score, max_disp: ", max_score.shape, max_disp.shape)
    ...
    def update_state(self, new_pos, new_scale = None):
        # Update scale
        print("new_pos: ", new_pos, type(new_pos))
